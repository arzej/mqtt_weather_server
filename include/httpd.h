...
public:
  ...
  typedef int (*uri_handler_f)(req_method_t method, const req_data_t& req,
                               response_data_t& response, void* param);
  ...
  int registerHttpCallbackRequest(const char* path, uri_handler_f handler,
                                  void* param = NULL);
